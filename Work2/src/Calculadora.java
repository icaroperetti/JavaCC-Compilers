...
public class Calculadora implements CalculadoraConstants {
  ...
  final public double unitario() throws ParseException {
    Token t;
    Double d;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NUMBER:
      ...
      break;
    case ABRIR_PARENTESES:
      jj_consume_token(ABRIR_PARENTESES);
      d = expressao();
      jj_consume_token(FECHAR_PARENTESES);
                                                                 {if (true) return d;}
      break;
    case MENOS:
  ...
  final public double expressao() throws ParseException {
   double a;
   double b;
    a = termo();
    label_3:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x490,0x490,0x1300,0x1300,0xc0,0xc0,};
   }
